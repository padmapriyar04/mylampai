...
export function TalentComponent() {
  return (
    <div className="hover:text-black text-[#697386] flex items-center gap-2 group focus:text-black transition-all py-2 px-4 rounded-lg duration-500 hover:transform ">
      <div>Talent</div>
      <ChevronDown className="w-4 h-4 text-[#697386] group-hover:-rotate-180 group-hover:text-black transition-all duration-100" />

      <div className="max-h-0 flex flex-col items-center overflow-hidden opacity-0 scale-75 transition-all duration-500 group-hover:max-h-screen group-focus:max-h-screen group-hover:opacity-100 group-hover:scale-100 group-focus:flex group-focus:opacity-100 group-focus:scale-100 absolute top-[110%] left-0 bg-[#f9f9f9] w-[600px] rounded-xl shadow-[0px_0px_1px_rgba(0,0,0,0.3)] px-2">
        <Link
          href={"/community"}
