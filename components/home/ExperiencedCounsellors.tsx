...
const CounsellorCard: React.FC<CounsellorCardProps> = ({
  ...
  return (
    <div className="w-full max-w-[260px] flex flex-col items-center bg-white rounded-xl overflow-hidden shadow-md">
        ...
        <div className="w-full my-8 rounded-2xl shadow-md">
          ...
          >
            <CarouselContent className="pt-2 pb-6">
              <CarouselItem className="basis-[100%] lg:basis-1/2 xl:basis-1/3 flex justify-center items-center">
                <CounsellorCard
                  name="Fiona Claudia"
          ...
          <div className="flex flex-wrap gap-4 justify-evenly bg-primary-foreground py-8 px-4 mt-4">
