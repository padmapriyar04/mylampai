...
export const PATCH = async (req: NextRequest, { params }: { params: { moduleId: string, chapterId: string, lessonId: string } }) => {
    ...
    try {
        ...
        if (!data.Lesson_Name || !data.content_url || !data.video_url || !data.Assesment_url) {
