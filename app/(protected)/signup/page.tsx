    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex relative">
        ...
        <div className="bg-purple-100 h-[300px] w-[660px] rounded-3xl relative flex flex-col items-start justify-center">
          <h1 className="text-black text-[20px] absolute left-[25px] top-[10px]">
            Where do you want to study?
          </h1>
          <form
            className="relative left-[20px] top-[18px] flex flex-col justify-between h-full w-full pt-[40px] pb-[60px]"
          ...
          >
            <div className="flex-grow">
              ...
              ].map(({ name, img }: { name: string; img: string }, index) => (
                <div
                  key={index}
                  className={`bg-purple-100 border border-gray-300 hover:bg-white h-[50px] w-[200px] rounded-full inline-flex items-center m-[5px] pl-[10px] cursor-pointer ${
                    selectedCountry === name ? "bg-white" : ""
                  }`}
            ...
            <button
              type="submit"
              className="bg-gray-300 border border-gray-300 text-gray-200 px-4 py-2 rounded-full inline-flex items-center space-x-2 self-center mb-1 hover:bg-purple-800 mt-auto"
            >
              <span>Next</span>
