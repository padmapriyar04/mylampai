      ...
      <div className="flex flex-col max-w-screen overflow-hidden bg-primary-foreground">
        <div className="flex justify-evenly items-center min-h-[555px] md:min-h-[700px] pt-4 px-8 gap-8 w-full m-auto">
          <div className="flex flex-col justify-center lg:justify-end min-h-[600px] w-full">
            ...
            <Link href={"/login"} className="flex items-center justify-between bg-[#8C52FF] rounded-full duration-150 hover:scale-[1.02] text-white text-xl md:text-2xl font-semibold py-2 md:py-3 pl-4 md:pl-8 px-2 md:px-3 max-w-[232px] md:max-w-[300px] mb-12 lg:ml-14">
              Let&apos;s Get Started
              <Image
              ...
              <div className="hidden xl:flex flex-col bg-[#f5f5f580] hover:bg-[#f1eaff] transition-all duration-200 p-4 rounded-2xl max-w-[260px]">
                <div className="flex justify-between">
                  <div className="flex gap-2">
                    <Link href={"https://t.me/+E95suGL1idQ2ZWRl"} target="_blank" className="p-2 bg-white  rounded-full hover:bg-primary-foreground duration-400 w-11 h-11 flex items-center justify-center">
                      <svg
                    ...
                    <Link href={"https://discord.gg/eaAQr79t"} target="_blank" className="p-2 bg-white  rounded-full hover:bg-primary-foreground duration-400 w-11 h-11 flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="28"
                        height="28"
                    ...
                    <Link href={"https://chat.whatsapp.com/G8sVXPrblUwDkttwTxnb2z"} target="_blank" className="p-2 bg-white  rounded-full hover:bg-primary-foreground duration-400 w-11 h-11 flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="28"
                        height="28"
