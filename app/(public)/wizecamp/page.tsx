  ...
  return (
    <>
      ...
      <div className={` transition `}>
        <div
          className={`bg-primary min-h-[calc(100vh-4rem)] w-full flex justify-evenly items-center text-white p-4 `}
        >
        ...
        <div className=" relative w-full flex justify-top text-black gap-4 p-4 bg-white">
          ...
          <div className="bg-primary-foreground flex flex-col shadow-2xl w-full rounded-xl p-6 gap-6">
