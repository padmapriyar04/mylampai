...
export default function Careers() {
  ...
  const renderForm = () => {
    switch (selectedProfile) {
      case "type3":
        return <div className="p-4 h-1/2 font-medium text-lg">Form 1</div>;
      case "type2":
        return <div className="p-4 h-1/2 font-medium text-lg">Form 2</div>;
      case "type1":
        return <div className="p-4 h-1/2 font-medium text-lg">Form 3</div>;
      default:
        return (
          <div className="font-medium text-lg">Please select a form.</div>
        );
    }
  };
        ...
        <div className="sticky top-[5rem] left-0 max-h-[calc(100vh-6rem)] max-w-[20vw] w-full rounded-xl items-center flex flex-col justify-start gap-[2vh]">
          <div className="bg-white h-[calc(40vh-2rem)] w-full 2xl:p-6 md:p-2 rounded-lg flex flex-col shadow-lg justify-evenly">
            ...
            <div className="flex flex-col justify-evenly">
              <button
                className={`w-full mb-2 p-2 rounded  2xl:text-md  md:text-sm transition text-white ${
                  selectedProfile === "type3"
                    ? "border-purple-400 border-2 bg-primary"
                    : "bg-primary"
                }`}
